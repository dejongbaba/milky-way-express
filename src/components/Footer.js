    ...
    return (
        <div className="bg-[#6B7165] md:flex items-stretch relative overflow-hidden px-40 pt-5 pb-5 hidden">
            ...
            <div className="px-10 flex-1 flex flex-col items-start justify-start">
                ...
                <p>
                    <span className="font-bold">Warning :</span> This website is not actually real, i just made it to
                    showcase my work, so if you buy something, you will be giving me your money for free 😅
                </p>
            </div>
            <div className="flex flex-col gap-2 border-l border-[#ffffff5e] px-10 flex-1 justify-center">
                ...
                <a target="_blank" rel="noreferrer" className="hover:underline" href="https://github.com/Lacamoura48">
                    {" "}
                    My Github
                </a>
                <a target="_blank" rel="noreferrer" className="hover:underline" href="#">
                    My portfolio
                </a>
                <Link className="hover:underline" href="">
                    See the plants
                </Link>
                <a target="_blank" rel="noreferrer" className="hover:underline" href="https://discord.gg/gqdSSGksU6">
                    My Discord
                </a>
            </div>
            <div className="flex flex-col px-10 border-l border-[#ffffff5e] justify-around flex-1 items-center">
                <div className="flex gap-3">
                    <a
                        ...
                        href="https://github.com/Lacamoura48">
                        <FontAwesomeIcon
                            icon={faGithub}
                    ...
                    <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/anas-sghir-158766238">
                        <FontAwesomeIcon
                            icon={faLinkedin}
                            className="opacity-60 hover:opacity-100"
                            style={{ fontSize: 25, color: "white" }}
                    ...
                    <a target="_blank" rel="noreferrer" href="https://www.youtube.com/channel/UCM40mt0MTQp634y6XWX-Eug">
                        {" "}
                        <FontAwesomeIcon
                            icon={faYoutube}
                            className="opacity-60 hover:opacity-100"
