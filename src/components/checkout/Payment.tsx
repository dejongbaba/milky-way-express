                    ...
                    <Form className="bg-gray-100 rounded-lg p-5 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <PaystackButton
                                    {...config}
                                    className="bg-primary text-white border-primary rounded ring-transparent focus:outline-none hover:ring-2 disabled:opacity-40 hover:ring-offset-1 hover:ring-primary hover:border-primary hover:text-white"
                                />
                            </div>
                        </div>
                    </Form>
