                    ...
                    <form className="w-full flex flex-col md:text-xl md:mt-20 mt-10 md:gap-10 gap-5 md:w-[470px]">
                        ...
                        <div className="relative">
                            <input
                                ...
                                name="email"
                                id="email"
                                className={`border border-1 border-gray-300 rounded-xl focus:bg-gray-200 hover:bg-gray-200 pl-12 py-3 outline-none  w-full ${EError && "border-[0.7px] border-red-500"}`}
                        ...
                        <div className="relative">
                            <input
                                ...
                                name="pass"
                                id="pass"
                                className={`border border-1 border-gray-300 rounded-xl focus:bg-gray-200 hover:bg-gray-200 pl-12 py-3 outline-none w-full ${PError && "border-[0.7px] border-red-500"}`}
                        ...
                        <button
                            onClick={signin}
                            type="submit"
                            className="bg-primary rounded-xl px-6 py-3 text-white hover:bg-[#5d6c50]">
                            Login
                        </button>
                    </form>
                    <p
