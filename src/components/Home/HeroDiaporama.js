  ...
  return (
    ...
    {plants.map((item, index)=>{
       ...
       {plants.map((item, index)=>{
        ...
        <Link href={{ pathname: '/products/[id]',query: { id: current == 0 ? '1' : current==1 ? '2' : '3' }}} ><button className="transition hover:bg-[#657457] bg-[#7D916C] text-white py-3 px-6 rounded-full text-[20px]">view details</button></Link>
