...
function WhyPlants() {
    return (
        <section className="bg-[#6B7165] md:px-56 px-5 pb-16 relative overflow-hidden">
            <img
                src="images/plant_svg.svg"
                className="absolute -right-60 -bottom-60 w-1/2 opacity-20 hidden md:block"
                alt=""
            />
            ...
            <div className="flex flex-col md:flex-row md:gap-0 gap-10 md:justify-around md:items-center">
                ...
                <p className="md:w-1/2 text-[18px] md:leading-10 text-gray-200 font-serif">
                    When you feel down, it’s amazing what a walk in the park can do. That’s because when we get in{" "}
                    <span className="font-semibold">touch with nature</span>, we improve our wellbeing. Studies show
                    time spent outside in green spaces can reduce our mental fatigue, increase our relaxation, and even
                    improve our cognition. Not only do{" "}
                    <span className="font-bold">indoor plants enhance the overall appearance of a space</span>, but
                    studies show they boost moods, increase creativity, reduce stress, and eliminate air
