    ...
    <section className='min-h-screen w-full bg-[url(https://i.ibb.co/cgyY7sr/background.jpg)] bg-cover bg-no-repeat bg-center relative z-10 flex items-center md:px-36 px-5 pt-20 pb-10'>
        ...
        <div className='z-10 flex justify-around w-full  items-center'>
            <div>
                ...
                <Link href={{pathname : '/products'}}><button className=" transition hover:bg-[#d9d9d948] text-white py-3 px-6 rounded-full text-[20px] border-[0.5px]">View plants</button></Link>
            </div>
            <div>
              <HeroDiaporama />
            </div>
