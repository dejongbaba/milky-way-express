    ...
    <nav className='  md:px-48 px-5 fixed top-0 w-full z-20  transition-all'>
      <div className='max-w-4xl m-auto  flex  items-center justify-between'>
        <div className="flex items-center">
          {scrolled ? (<Link href="/"><img className="w-36 pt-2 mr-16 cursor-pointer" src="/images/svg/logo.svg" alt="" /></Link>) : (<Link href="/"><img className="w-36 pt-2 mr-16 cursor-pointer" src="/images/svg/logo.svg" alt="" /></Link>)}
        ...
        <ul className="flex gap-5 items-center space-x-3 ">
          ...
          <li onClick={()=> dispatch(uiActions.showCart())} className={`flex items-center  p-1  transition cursor-pointer`}>
